...
<body>
	...
	List<Vendor> vendorsSt = new ArrayList<Vendor>();
	List<Order> ordersSt = new ArrayList<Order>();
	try {
		OrderDAO odao = new OrderDAO();
		vendorsSt = vdao.getVendors();
		ordersSt = odao.getOrders();
	}catch (Exception e){
	}
	%>
			...
			<div class="row">
				<div class="col-md-4 col-sm-4 col-4 stats-container">
					...
					<div class="stats-wrapper">
						<p class="stats-number" data-stop="<%= vendorsSt.size() %>"><%= vendorsSt.size() %></p>
				...
				<div class="col-md-4 col-sm-4 col-4 stats-container">
					...
					<div class="stats-wrapper">
						<p class="stats-number" data-stop="<%= ordersSt.size()%>"><%= ordersSt.size()%></p>
						<p class="stats-text">Orders completed&emsp;</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-4  stats-container">
					...
					<article class="article-post">
						...
						<ul class="article-footer">
							...
							<li class="article-comments">
								<span><i class="fa fa-star"></i><%=pdao.getAverageRatings(product) %>&emsp;</span>
							</li>
						</ul>
					</article>
				</div>
...
%>
	...
	<section class="crew has-padding" id="team">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<br><h1 class="text-center"><small>We are currently looking to expand. Want to join our young team?Have a look <a class="bold italic" href="#">here</a>.</small></h1>
				</div>
			</div>
		</div>
	</section>
