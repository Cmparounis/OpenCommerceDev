...
import exercise2_8130081.*;

public class RegisterController_ex2_8130081 extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    User myUser = (User)session.getAttribute("ex2-user-object");
    ...
    try{
		...
		response.sendRedirect("http://ism.dmst.aueb.gr/ismgroup42/index_ex2_8130081.jsp");
	}
	...
	try {
		...
		out.println("					<li><a href='../index_ex2_8130081.jsp'>Home</a></li>");
		out.println("					<li class='active'><a href='../register_ex2_8130081.jsp'>Register</a></li>");
		out.println("					<li><a href='../about_ex2_8130081.jsp'>About</a></li>");
		out.println("				</ul>");
		...
		out.println("							<li><a href='../logout_ex2_8130081.jsp'><span class='glyphicon glyphicon-log-out'></span> Logout</a></li>");
		out.println("						</ul>");
		out.println("					</li>");
		out.println("				</ul>");
		out.println("			</div>");
		...
		if ( checkData.isAmValid(am) && checkData.isFullnameValid(fullname) && checkData.isValidPhoneNumber(phone) &&
			...
			out.println("		<a href='../register_ex2_8130081.jsp'>");
